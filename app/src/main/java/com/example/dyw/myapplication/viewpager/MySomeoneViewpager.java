package com.example.dyw.myapplication.viewpager;
...
public class MySomeoneViewpager extends ViewPager{
    ...
    public MySomeoneViewpager(Context context, AttributeSet attrs)
    {
        super(context, attrs);
    }
