...
public class SomeoneActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        list = (ArrayList) intent.getSerializableExtra("idbl");


        TextView main_someone_title = (TextView) findViewById(R.id.main_someone_title);
        TextView main_someone_content = (TextView) findViewById(R.id.main_someone_content);
        TextView main_someone_location = (TextView) findViewById(R.id.main_Someone_location);
        TextView main_someone_how = (TextView) findViewById(R.id.main_someone_how);
        TextView main_someone_device = (TextView) findViewById(R.id.main_someone_device);
        TextView main_someone_info = (TextView) findViewById(R.id.main_someone_info);
        TextView main_someone_name = (TextView) findViewById(R.id.main_someone_name);
        View main_someone_phone = (View) findViewById(R.id.main_someone_phone);
...
//        System.out.println("SomeoneActivity collectHouseOwnerList:"+collectHouseOwnerList.size());
        ...
        System.out.println("--------houseOwnerPhone:"+houseOwnerPhone);
